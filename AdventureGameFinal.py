...
skillPoints=100
maxhealth=powerwash(0,skillPoints,f'\nyou have {skillPoints} skillpoints\nhow many do you want to spent on health?\n','you cannot do that')
skillPoints-=maxhealth
health=maxhealth
damage=powerwash(0,skillPoints+1,f'\nyou have {skillPoints} skillpoints\nhow many do you want to spent on damage?\n','you cannot do that')
skillPoints-=damage
...
if name=='dev':
    ...
    damage=1000000000000
    i+=50
elif health<=5 and name=='glass cannon':
    skill=powerwash(0,3,'\nwould you like the secret class "glass cannon"?\n1 -> Yes\n2 -> No\n','choose Yes or No\n')
    if skill==1:
        Type='glass cannon'
        damage=200
        health=5
        maxhealth=5
if damage<=5 and name=='tank':
    skill=powerwash(0,3,'\nwould you like the secret class "tank"?\n1 -> Yes\n2 -> No\n','choose Yes or No\n')
    if skill==1:
        Type='tank'
        health=300
        maxhealth=300
        damage=5
if damage==5 and health==5 and name=='hollow':
    skill=powerwash(0,3,'\nwould you like the secret class "hollow"?\n1 -> Yes\n2 -> No\n','choose Yes or No\n')
    if skill==1:
        Type='hollow'
        health=10
        maxhealth=10
                    ...
                    if encounter==0:
                        ...
                        if player.health<=0:
                            ...
                            if Type!='hollow':
                                ...
                                print('You absorb their power making you feel a little less hollow')
                                player.maxhealth+=5
                                player.health+=5
                                player.damage+=5
                                player.shield+=5
...
if i<100:
    ...
    while player.health>0 and TOM.health>0: #change
        ...
        if attack==1:
            ...
            print(f'health 1000{TOM.health}/1000100\nshield 10000{TOM.shield}/1000050')  #change     
            wait=input('\npress enter to continue\n ----------')
        elif attack==2:
            print(f'healing {player.name}')
            player.health+=15
    ...
    if player.health<=0:
        ...
        if Type=='':
            ...
            print(f"{TOM.name}'s Stats:\n  Health: 1000000\n shield: 1000000\n Damage: {TOM.damage}") #change
            wait=input('press enter to continue\n ----------')
            print(f'You fought well against {TOM.name} but you are not able to defeat him')
            wait=input('press enter to continue\n ----------')
            print(f'as {TOM.name} kills you he says\n\nplay the game again but\nput no more than 5 skillpoints into health\nand\nname yourself "glass cannon"\n')
            wait=input('press enter to continue\n ----------')
            print(f'do this and you will get closer to defeating me')
            wait=input('press enter to continue\n ----------')
            print('*BOOOOOOOOOM')
            print(f"{player.name}'s Stats:\n Health: 0\n shield: 0\n Damage: {player.damage}")
            print('Game Over')
            ...
            print(f"{TOM.name}'s Stats:\n  Health: 1000000\n shield: 1000000\n Damage: {TOM.damage}") #change
            wait=input('press enter to continue\n ----------')
            print(f'You fought well against {TOM.name} but you are still not able to defeat him')
            wait=input('press enter to continue\n ----------')
            print(f'as {TOM.name} kills you yet again he says\nYou have gotten stronger but you are still not strong enough\n\nplay the game again but\nput no more than 5 skillpoints into damage\nand\nname yourself "tank"\n')
            wait=input('press enter to continue\n ----------')
            print(f'do this and you will get closer to defeating me')
            wait=input('press enter to continue\n ----------')
            print('*BOOOOOOOOOM')
            ...
            print(f'You fought well against {TOM.name} but you are still not able to defeat him')
            wait=input('press enter to continue\n ----------')
            print(f'as {TOM.name} kills you yet again he says\nYou have gotten stronger but you are still not strong enough\n\nplay the game again but\nput 5 skillpoints into damage\nput 5 skill points into health\nand\nname yourself what you are\n"hollow"\n')
            wait=input('press enter to continue\n ----------')
            print(f'I look foward to our battle')
            wait=input('press enter to continue\n ----------')
            print('*BOOOOOOOOOM')
            print(f"{player.name}'s Stats:\n Health: 0\n shield: 0\n Damage: {player.damage}")
            print('Game Over')
            ...
            print(f"{TOM.name}'s Stats:\n  Health: {TOM.health}\n shield: {TOM.shield}\n Damage: {TOM.damage}") #change
            wait=input('press enter to continue\n ----------')
            print(f'By surviving {TOM.name} you are able to absorb their power') #change
            if player.health>0:
            ...
            wait=input('press enter to continue\n ----------')
            print(f'with their final breath {TOM.name} says that he has been honored to be defeated by such a powerful opponent')
            wait=input('press enter to continue\n ----------')
            print('You have found the power within the temple and filled the void within yourself')
            wait=input('press enter to continue\n ----------')
            print('By satisfying your soul you have beaten and finished the game!')
            wait=input('press enter to continue\n ----------')